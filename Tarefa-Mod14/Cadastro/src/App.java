...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (!isOpcaoValida(opcao)) {
            ...
            opcao = JOptionPane.showInputDialog(null, "Opção inválida digite 1 para cadastro, 2 para consulta, 3 para cadastro, 4 para alterar ou 5 para sair", "Green diner", JOptionPane.INFORMATION_MESSAGE);
        }
        ...
        while (isOpcaoValida(opcao)) {
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null, "Digite os dados do cliente separados por virgula, conforme exemplo: Nome, CPF, Tel, Endereço, Número, Cidade e Estado ", "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                cadastrar(dados);
            ...
            opcao = JOptionPane.showInputDialog(null, "Digite 1 para cadastro, 2 para consulta, 3 para cadastro, 4 para alteração ou 5 para sair", "Green dinner", JOptionPane.INFORMATION_MESSAGE);
        }
    }
...
//        Cliente cliente = new Cliente(dadosSeparados[0], null null null )
